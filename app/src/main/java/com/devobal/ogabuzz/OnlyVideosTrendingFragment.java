...
/**
 * Created by Devobal on 3/8/2019 on 10:23 PM.
 */
public class OnlyVideosTrendingFragment extends Fragment {

    RecyclerView listview;
    VideosTrendListViewAdapter adapter;
    VideosTrendGridAdapter gridAdapter;
    ...
    View view;
    String searchtext="",category,sessionid,sellanglist="";
    ArrayList<String> langid=new ArrayList<String>();
    int listposition,listlenght=20;
    static String language="";
    ShimmerFrameLayout sflayout;
    TextView followmoose,optionshare,optioncomment;
    Boolean fromlistdetails=false,isLoading=false,scrollLoop=false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        followmoose = ((Activity)getActivity()).findViewById(R.id.followmoose);
        optionshare = ((Activity)getActivity()).findViewById(R.id.optionshare);
        optioncomment = ((Activity)getActivity()).findViewById(R.id.optioncomment);
        ...
        adapter = new VideosTrendListViewAdapter(OnlyVideosTrendingFragment.this,listModelArrayList,listview);
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!isLoading) {
                    if (linearLayoutManager != null && linearLayoutManager.findLastCompletelyVisibleItemPosition()
                        ...
                        int onsd=linearLayoutManager.findLastCompletelyVisibleItemPosition();
                        //bottom of list!
        ...
        /*listModelArrayList = new ArrayList<ListModel>();
        adapter = new VideosTrendListViewAdapter(OnlyVideosTrendingFragment.this,listModelArrayList);
        gridAdapter = new VideosTrendGridAdapter(OnlyVideosTrendingFragment.this,listModelArrayList);
    ...
    public static OnlyVideosTrendingFragment newInstance(String text, String searchtext, String languagetext) {
        OnlyVideosTrendingFragment f = new OnlyVideosTrendingFragment();
        Bundle b = new Bundle();
        ...
        try {
            ...
            httpClient.addInterceptor(new Interceptor() {
                ...
                public okhttp3.Response intercept(Chain chain) throws IOException {
                    ...
                    if (Utility.isNotAnValidString(searchtext)){
                        Request request = original.newBuilder()
                                .header("authenticate_key", "abcd123XYZ")
                                .header("limit", String.valueOf(listlenght))
                                .header("action_type", "trending_video")
                                .method(original.method(), original.body())
                                .build();
    ...
    public void postGridData(String s) {
        try {
            //dismissProgressDislogue();
            sflayout.stopShimmerAnimation();
            sflayout.setVisibility(View.GONE);
    ...
    public void loopData(JSONObject dataobj){
        try {
            ...
            model.setNewsid(dataobj.getString("id"));
            model.setVideopath(dataobj.getString("video_path"));
            model.setVideo_thumb_image(dataobj.getString("video_thumb_image"));
            model.setNooflike(dataobj.getString("news_like_count"));
            model.setNoofview(dataobj.getString("news_view_count"));
            model.setNoofcomnts(dataobj.getString("news_comment_count"));
            model.setNewsfrom(dataobj.getString("news_from"));
