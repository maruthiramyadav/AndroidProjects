...
/**
 * Created by Devobal on 2/11/2019 on 5:37 PM.
 */
public class FollowingListAdapter extends RecyclerView.Adapter<FollowingListAdapter.MyViewHolder>{
    ...
    AllFollowingList activity;
    AlertDialog removedialog;

    public FollowingListAdapter(AllFollowingList Activity, ArrayList<FollowModel> hFollowingLists) {
        activity=Activity;
