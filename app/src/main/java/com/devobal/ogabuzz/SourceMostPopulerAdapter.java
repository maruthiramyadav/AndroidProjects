...
public class SourceMostPopulerAdapter extends RecyclerView.Adapter<SourceMostPopulerAdapter.MyViewHolder>{
    Sources context;
    ArrayList<SourcesListModal> arrayList;
    public SourceMostPopulerAdapter(Sources activity, ArrayList<SourcesListModal> sourcesListModals) {
