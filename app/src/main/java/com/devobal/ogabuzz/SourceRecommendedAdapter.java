...
public class SourceRecommendedAdapter extends RecyclerView.Adapter<SourceRecommendedAdapter.MyViewHolder>{

    Sources context;
    ArrayList<SourcesListModal> arrayList;
    public SourceRecommendedAdapter(Sources sources, ArrayList<SourcesListModal> sourcesListModals) {
