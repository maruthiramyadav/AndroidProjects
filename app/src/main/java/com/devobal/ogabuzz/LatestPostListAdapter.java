...
/**
 * Created by Devobal on 3/19/2019 on 1:00 AM.
 */
public class LatestPostListAdapter extends BaseAdapter {

    LatestPostActivity context;
    ...
    public LatestPostListAdapter(LatestPostActivity context, ArrayList<ListModel> listModelArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        optionsMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.bottomlayout.setVisibility(View.VISIBLE);
            }
        });
        ...
        context.optionfollow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
