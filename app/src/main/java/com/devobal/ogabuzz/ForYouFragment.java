...
public class ForYouFragment extends Fragment implements AbsListView.OnScrollListener,View.OnClickListener {

    RecyclerView listview;
    ForYouListViewAdapter adapter;
    ProgressBar pbar;
    ...
    View view;
    String sessionid, category="",catid,searchtext="",sellanglist="";
    ...
    Boolean fromlistdetails=false;
    int listlenght=20,listposition;
    boolean isLoading = false,scrollLoop=false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       /* listtypeview=((Activity)getActivity()).findViewById(R.id.listtypeview);
        ...
        adapter = new ForYouListViewAdapter(ForYouFragment.this,listModelArrayList,listview);
    ...
    public static ForYouFragment newInstance(String text, String searchtext, String languagetext, String cat_id) {
        ForYouFragment f = new ForYouFragment();
        Bundle b = new Bundle();
                ...
                public okhttp3.Response intercept(Chain chain) throws IOException {
                    ...
                    if (Utility.isNotAnValidString(searchtext)){
                        Request request = original.newBuilder()
                                ...
                                .header("searchtxt", searchtext)
                                .header("language", sellanglist)
    ...
    private void UserLanguagesGet() {
        try {
            ...
            httpClient.addInterceptor(new Interceptor() {
                ...
                public okhttp3.Response intercept(Chain chain) throws IOException {
                    Request original = chain.request();
                    String usid=preferenceUtils.getUserId();
                    Request request = original.newBuilder()
                            .header("authenticate_key", "abcd123XYZ")
                            .header("limit", "all")
                            .header("offset", "")
