...
/**
 * Created by Devobal on 3/8/2019 on 9:50 PM.
 */
public class NewsTrendGridAdapter extends RecyclerView.Adapter<NewsTrendGridAdapter.MyViewHolder> {
    ...
    public NewsTrendGridAdapter(OnlyNewsTrendingFragment context, ArrayList<ListModel> listModelArrayList) {
   ...
   /* @Override
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView newsimg,videoimg,sharearrow,optionsMenu,imageView,likeimage;
