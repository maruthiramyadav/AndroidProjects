...
public class TopicsFeaturedAdapter extends RecyclerView.Adapter<TopicsFeaturedAdapter.MyViewHolder>{
    Topics context;
    ArrayList<SourcesListModal> arrayList;
    public TopicsFeaturedAdapter(Topics topics, ArrayList<SourcesListModal> sourcesListModals) {
        this.context=topics;
