...
public class TrendingNewsFragment extends Fragment implements View.OnClickListener{
        ...
        public Fragment getItem(int pos) {
            ...
            for (int i = 0; i < catlist.size() ; i++) {
                if (i == pos) {
                    ...
                    fragment= OnlyNewsTrendingFragment.newInstance(catlist.get(pos).getCat_name(),searchtext, languagetext);
                    break;
                }
            }
            return OnlyNewsTrendingFragment.newInstance(catlist.get(pos).getCat_name(),searchtext, languagetext);
        }
