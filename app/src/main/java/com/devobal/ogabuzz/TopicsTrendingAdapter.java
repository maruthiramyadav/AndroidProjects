...
public class TopicsTrendingAdapter extends RecyclerView.Adapter<TopicsTrendingAdapter.MyViewHolder>{
    Topics context;
    ArrayList<SourcesListModal> arrayList;
    public TopicsTrendingAdapter(Topics topics, ArrayList<SourcesListModal> sourcesListModals) {
        this.context=topics;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.topicschild,parent,false);
