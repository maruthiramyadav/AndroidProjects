...
public class PathInterpolatorCompat {
    ...
    public static Interpolator create(Path path) {
        if (Build.VERSION.SDK_INT >= 21) {
            return omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.PathInterpolatorCompatApi21.create(path);
        }
        return omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.PathInterpolatorCompatBase.create(path);
    }
    ...
    public static Interpolator create(float controlX, float controlY) {
        if (Build.VERSION.SDK_INT >= 21) {
            return omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.PathInterpolatorCompatApi21.create(controlX, controlY);
        }
        return omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.PathInterpolatorCompatBase.create(controlX, controlY);
    }
    ...
    public static Interpolator create(float controlX1, float controlY1,
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            return omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.PathInterpolatorCompatApi21.create(controlX1, controlY1, controlX2, controlY2);
        }
        return omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.PathInterpolatorCompatBase.create(controlX1, controlY1, controlX2, controlY2);
    }
}
