...
import omgbuzz.devobl.com.testprojectone.Spinkit.animation.interpolator.KeyFrameInterpolator;
...
public class SpriteAnimatorBuilder {
    ...
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder scale(float fractions[], Float... scale) {
        holder(fractions, Sprite.SCALE, scale);
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder alpha(float fractions[], Integer... alpha) {
        holder(fractions, Sprite.ALPHA, alpha);
        return this;
    }

    @SuppressWarnings("unused")
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder scaleX(float fractions[], Float... scaleX) {
        holder(fractions, Sprite.SCALE, scaleX);
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder scaleY(float fractions[], Float... scaleY) {
        holder(fractions, Sprite.SCALE_Y, scaleY);
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder rotateX(float fractions[], Integer... rotateX) {
        holder(fractions, Sprite.ROTATE_X, rotateX);
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder rotateY(float fractions[], Integer... rotateY) {
        holder(fractions, Sprite.ROTATE_Y, rotateY);
        return this;
    }

    @SuppressWarnings("unused")
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder translateX(float fractions[], Integer... translateX) {
    ...
    @SuppressWarnings("unused")
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder translateY(float fractions[], Integer... translateY) {
        holder(fractions, Sprite.TRANSLATE_Y, translateY);
        return this;
    }


    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder rotate(float fractions[], Integer... rotate) {
        holder(fractions, Sprite.ROTATE, rotate);
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder translateXPercentage(float fractions[], Float... translateXPercentage) {
        holder(fractions, Sprite.TRANSLATE_X_PERCENTAGE, translateXPercentage);
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder translateYPercentage(float[] fractions, Float... translateYPercentage) {
    ...
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder interpolator(Interpolator interpolator) {
        this.interpolator = interpolator;
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder easeInOut(float... fractions) {
    ...
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder duration(long duration) {
        this.duration = duration;
        return this;
    }

    @SuppressWarnings("unused")
    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder repeatCount(int repeatCount) {
        this.repeatCount = repeatCount;
        return this;
    }

    public omgbuzz.devobl.com.testprojectone.Spinkit.animation.SpriteAnimatorBuilder startFrame(int startFrame) {
        if (startFrame < 0) {
