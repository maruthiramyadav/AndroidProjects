...
import omgbuzz.devobl.com.testprojectone.Spinkit.SpinKitView;
...
import omgbuzz.devobl.com.testprojectone.Spinkit.style.WanderingCubes;
import omgbuzz.devobl.com.testprojectone.Spinkit.style.Wave;
import omgbuzz.devobl.com.testprojectone.VideoView.subtitle.CaptionsView;
import omgbuzz.devobl.com.testprojectone.VideoView.utility.EmptyCallback;
import omgbuzz.devobl.com.testprojectone.VideoView.utility.Util;
...
public class BetterVideoPlayer extends RelativeLayout implements IUserMethods,
  ...
  public static final int FULLSCREEN_BUTTON = 3;

  @IntDef({PLAY_BUTTON, PAUSE_BUTTON, RESTART_BUTTON,FULLSCREEN_BUTTON})
  @Retention(RetentionPolicy.SOURCE)
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    if (attrs != null) {
      ...
      try {
        ...
        mFullscreenDrawable = a.getDrawable(
                R.styleable.BetterVideoPlayer_bvp_autoFullscreen);
    ...
    if (mFullscreenDrawable == null)
      mFullscreenDrawable = ContextCompat.getDrawable(context,R.drawable.bvp_action_fullscreen);
  ...
  @Override
  public void setButtonDrawable(@omgbuzz.devobl.com.testprojectone.VideoView.BetterVideoPlayer.ButtonType int type,
...
//        }
  ...
  public void seekTo(@IntRange(from = 0, to = Integer.MAX_VALUE) int pos) {
      ...
      int mseekbarmx = mSeeker.getMax();
      double cnmx = ((pos/(float)mseekbarmx)*100);
      int mseektoposition = (int) cnmx;
      /*if (mseektoposition > mBuufferedPercent){
          String po = String.valueOf(mBuufferedPercent);
          String rm ="1";
          for (int w=0;w<String.valueOf(mseekbarmx).length();w++){
              if (po.length()!=String.valueOf(mseekbarmx).length()){
                  po = po+"0";
              }
            rm = rm+"0";
          }
  ...
  public void setLoadingStyle(@LoadingStyle int style) {
    ...
    switch (style) {
      ...
      case WANDERING_CUBES:
        ...
        break;
      case PULSE:
        drawable = new omgbuzz.devobl.com.testprojectone.Spinkit.style.Pulse();
        break;
      case CHASING_DOTS:
        drawable = new omgbuzz.devobl.com.testprojectone.Spinkit.style.ChasingDots();
        break;
      case THREE_BOUNCE:
      ...
      case CUBE_GRID:
        ...
        break;
      case FADING_CIRCLE:
        drawable = new omgbuzz.devobl.com.testprojectone.Spinkit.style.FadingCircle();
        break;
