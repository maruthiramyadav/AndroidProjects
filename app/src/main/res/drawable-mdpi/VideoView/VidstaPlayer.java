...
public class VidstaPlayer extends FrameLayout implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener,
    ...
    private ProgressBar proViewVideoLoading;
    ...
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoStartedListener onVideoStarted;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoPausedListener onVideoPaused;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoStoppedListener onVideoStopped;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoFinishedListener onVideoFinished;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoBufferingListener onVideoBuffering;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoErrorListener onVideoError;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoRestartListener onVideoRestart;

    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutCreated onLayoutCreated;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutResumed onLayoutResumed;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutPaused onLayoutPaused;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutDestroyed onLayoutDestroyed;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.FullScreenClickListener fullscreenToggleClickListener;
    private omgbuzz.devobl.com.testprojectone.VideoView.listeners.OnBackCalledListener onBackCalled;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                buttonTintColor = customAttr.getColor(R.styleable.VidstaPlayer_buttonTintColor, ContextCompat.getColor(getContext(), R.color.colorPrimary));
                textColor = customAttr.getColor(R.styleable.VidstaPlayer_textColor, ContextCompat.getColor(getContext(), R.color.colorPrimary));
            ...
            buttonTintColor = ContextCompat.getColor(getContext(), R.color.colorPrimary);
        }
    ...
    protected void onFinishInflate() {
        ...
        proViewVideoLoading = (ProgressBar) videoLoadingView.findViewById(R.id.proViewVideoLoading);
        ...
        proViewVideoLoading.setVisibility(VISIBLE);
        setUpVideoPlayer();
    }
    ...
    public void setOnBackCalled(omgbuzz.devobl.com.testprojectone.VideoView.listeners.OnBackCalledListener onBackCalled) {
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        tvPosition.setText(omgbuzz.devobl.com.testprojectone.VideoView.VidstaUtil.getTimeString(0, false));
        tvDuration.setText(omgbuzz.devobl.com.testprojectone.VideoView.VidstaUtil.getTimeString(videoDuration, true));
        proViewVideoLoading.setVisibility(GONE);
    ...
    private void setUpVideoPlayer() {
        ...
        if (textColor != ContextCompat.getColor(getContext(), R.color.colorPrimary)) {
            tvPosition.setTextColor(textColor);
            tvDuration.setTextColor(textColor);
        }

        if (buttonTintColor != ContextCompat.getColor(getContext(), R.color.colorPrimary)) {
    ...
    private final Runnable seekBarProgress = new Runnable() {
        ...
        public void run() {
            ...
            tvPosition.setText(omgbuzz.devobl.com.testprojectone.VideoView.VidstaUtil.getTimeString(videoPos, false));
            tvDuration.setText(omgbuzz.devobl.com.testprojectone.VideoView.VidstaUtil.getTimeString((videoLength - videoPos), true));
    ...
    public void setOnLayoutCreatedListener(@NonNull omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutCreated onLayoutCreated) {
        this.onLayoutCreated = onLayoutCreated;
    }

    public void setOnLayoutResumedListener(@NonNull omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutResumed onLayoutResumed) {
        this.onLayoutResumed = onLayoutResumed;
    }

    public void setOnLayoutPauseListener(@NonNull omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutPaused onLayoutPaused) {
        this.onLayoutPaused = onLayoutPaused;
    }

    public void setOnLayoutDestroyedListener(@NonNull omgbuzz.devobl.com.testprojectone.VideoView.listeners.LayoutStates.OnLayoutDestroyed onLayoutDestroyed) {
    ...
    public void setOnFullScreenClickListener(@NonNull omgbuzz.devobl.com.testprojectone.VideoView.listeners.FullScreenClickListener listener) {
    ...
    public void setOnVideoStartedListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoStartedListener onVideoStarted) {
        this.onVideoStarted = onVideoStarted;
    }

    public void setOnVideoRestartListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoRestartListener onVideoRestart) {
        this.onVideoRestart = onVideoRestart;
    }

    public void setOnVideoErrorListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoErrorListener onVideoError) {
        this.onVideoError = onVideoError;
    }

    public void setOnVideoBufferingListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoBufferingListener onVideoBuffering) {
        this.onVideoBuffering = onVideoBuffering;
    }

    public void setOnVideoFinishedListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoFinishedListener onVideoFinished) {
        this.onVideoFinished = onVideoFinished;
    }

    public void setOnVideoStoppedListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoStoppedListener onVideoStopped) {
        this.onVideoStopped = onVideoStopped;
    }

    public void setOnVideoPausedListener(omgbuzz.devobl.com.testprojectone.VideoView.listeners.VideoStateListeners.OnVideoPausedListener onVideoPaused) {
