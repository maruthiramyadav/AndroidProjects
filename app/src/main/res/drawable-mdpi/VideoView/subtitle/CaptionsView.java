...
public class CaptionsView extends AppCompatTextView implements Runnable {
    ...
    public void run() {
        if (player !=null && track!= null){
            ...
            setText(Html.fromHtml(
                    ...
                    (DEBUG?"[" + omgbuzz.devobl.com.testprojectone.VideoView.HelperMethods.secondsToDuration(seconds) + "] ":"")
    ...
    public void setCaptionsSource(@Nullable Uri path, CMime mime){
        ...
        if (omgbuzz.devobl.com.testprojectone.VideoView.HelperMethods.isRemotePath(path)) {
            try {
    ...
    private void getSubtitleFile(final URL url) {
        omgbuzz.devobl.com.testprojectone.VideoView.subtitle.DownloadFile downloader = new omgbuzz.devobl.com.testprojectone.VideoView.subtitle.DownloadFile(getContext(), new omgbuzz.devobl.com.testprojectone.VideoView.subtitle.DownloadCallback() {
            @Override
